...
$DB = new Model_Conf();
if (isset($_POST["name"])) {
    $query = $DB->select("INSERT INTO `conf` (`Title`, `Date`,`X_Coord`,`Y_Coord`,`Country`) 
VALUES ('{$_POST['name']}', '{$_POST['trip-start']}','{$_POST['xCord']}','{$_POST['yCord']}','{$_POST['country']}')");
...
<form method="post">
    ...
    <input type="text" id="xCord" name="xCord" placeholder="X Координата" class="form-control"><br>
    <input type="text" id="yCord" name="yCord" placeholder="Y Координата" class="form-control"><br>
